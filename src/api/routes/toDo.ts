...
export default (app: Router) => {
  ...
  route.post(
    ...
    async (req: Request, res: Response) => {
      try {
        ...
        const toDo = await toDoServiceInstance.Add(req.user as IUser, req.body as IToDo);
  ...
  route.patch(
    ...
    async (req: Request, res: Response) => {
      try {
        const toDoServiceInstance = Container.get(ToDoService);
        const toDo = await toDoServiceInstance.Update(req.user as IUser, req.body as IToDo);
